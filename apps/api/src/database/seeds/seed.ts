...
const DEFAULT_PERMISSIONS = [
  ...
  { resource: 'taxes', action: 'manage', scope: 'company' },
  { resource: 'warehouses', action: 'manage', scope: 'company' },
  { resource: 'items', action: 'manage', scope: 'company' },
  { resource: 'units-of-measure', action: 'manage', scope: 'company' },
  { resource: 'item-groups', action: 'manage', scope: 'company' },
  { resource: 'customers', action: 'manage', scope: 'company' },
  { resource: 'sales-orders', action: 'manage', scope: 'company' },
  { resource: 'sales-invoices', action: 'manage', scope: 'company' },
  { resource: 'delivery-notes', action: 'manage', scope: 'company' },
  { resource: 'quotations', action: 'manage', scope: 'company' },
  { resource: 'suppliers', action: 'manage', scope: 'company' },
  { resource: 'purchase-orders', action: 'manage', scope: 'company' },
  { resource: 'purchase-receipts', action: 'manage', scope: 'company' },
  { resource: 'purchase-invoices', action: 'manage', scope: 'company' },
  { resource: 'landed-costs', action: 'manage', scope: 'company' },
  { resource: 'asset-categories', action: 'manage', scope: 'company' },
  { resource: 'fixed-assets', action: 'manage', scope: 'company' },
